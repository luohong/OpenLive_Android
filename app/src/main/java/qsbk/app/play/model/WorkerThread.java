...
public class WorkerThread extends Thread {
    ...
    public final void enablePreProcessor() {
        if (mEngineConfig.mClientRole == io.agora.rtc.Constants.CLIENT_ROLE_BROADCASTER) {
            if (Constants.PRP_ENABLED) {
                if (mVideoEnhancer == null) {
                    mVideoEnhancer = new AgoraYuvEnhancer(mContext);
                    mVideoEnhancer.SetLighteningFactor(Constants.PRP_DEFAULT_LIGHTNESS);
                    mVideoEnhancer.SetSmoothnessFactor(Constants.PRP_DEFAULT_SMOOTHNESS);
    ...
    public final void setPreParameters(float lightness, float smoothness) {
        ...
        Constants.PRP_DEFAULT_LIGHTNESS = lightness;
        Constants.PRP_DEFAULT_SMOOTHNESS = smoothness;
